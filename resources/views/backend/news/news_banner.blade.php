...
<div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-11">
          <h1 class="m-0 text-dark"><i class="fa fa-newspaper-o" aria-hidden="true"></i>&nbsp;News Banner</h1>
        </div>
        <div class="col-sm-1">
    ...
    <div class="work-con">
        <div class="tab-content" id="master-tabContent">
            <div id="con_1" aria-labelledby="tab_1" role="tabpanel" class="tab-pane fade show active">
                <table class="table table-bordered data-table" id="list_news_banner" style="width: 100%;">
                    <thead>
                        <tr>
                            <th>#</th>
                            <th>Images</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $('#list_news_banner').DataTable({
            scrollY: true,
            scrollCollapse: true,
            searching: true,
            ajax:'{{url("news_banner_data")}}',
            columns : [
            { data : 'no' },
            { data : 'images' },
            { data : 'title_en' },
