...
{{ csrf_field() }}
    <table class="table table-bordered">
        <tr>
            ...
            <td><input type="date" name="datetime" id="datetime" format="YYYY-MM-DD"></td>
        </tr>
        <tr>
    ...
    <div class="modal-footer">
        ...
        <a href="{{ url('news')}}"><button type="button" class="btn btn-primary"><i class="fa fa-arrow-left" aria-hidden="true"></i>&nbsp;Back</button></a>
    </div>
</form>
  </section>
  @endsection
