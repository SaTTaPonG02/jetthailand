...
<div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-10">
          <h1 class="m-0 text-dark"><i class="fa fa-newspaper-o" aria-hidden="true"></i>&nbsp; News Product Images </h1>
        </div>
        <div class="col-sm-2">
            <a href="{{ url('insert_product_images/'.$id.'/'.$delete_id.'') }}">
    ...
    <div class="work-con">
        <div class="tab-content" id="master-tabContent">
            <div id="con_1" aria-labelledby="tab_1" role="tabpanel" class="tab-pane fade show active">
                <table class="table table-bordered data-table" id="list_product_images" style="width: 100%;">
                    <thead>
                        <tr>
                            <th>#</th>
                            <th>Images</th>
...
<script type="text/javascript">
  ...
  var token = $('meta[name="csrf-token"]').attr('content');
     ...
     var delete_id = document.getElementById("delete_id").value;
         $('#list_product_images').DataTable({
             scrollY: true,
             scrollCollapse: true,
             searching: true,
             "ajax": {
              "url": '{{url("product_images_data")}}',
              "type": 'GET',
              "data": {
                "id": id,
                "delete_id": delete_id,
